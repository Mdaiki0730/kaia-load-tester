...
func (cfg *Config) setConfigsFromFlag(ctx *cli.Context) {
	...
	cfg.strictNonceCheck = ctx.Bool("strictNonceCheck")
	...
	fmt.Printf("- strictNonceCheck = %v\n", cfg.strictNonceCheck)
}
...
func (cfg *Config) GetStrictNonceCheck() bool            { return cfg.strictNonceCheck }
...
var Flags = []cli.Flag{
	...
	cli.BoolFlag{Name: "strictNonceCheck", Usage: "strict nonce check for test accounts"},
